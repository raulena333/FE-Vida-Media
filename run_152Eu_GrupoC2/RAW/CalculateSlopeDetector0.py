...
# Output file paths
output_plot = './run_152Eu_GrupoC2/Results/EnergyDetector0_calibration.pdf'
param_file = './run_152Eu_GrupoC2/Results/Quadratic_fit_parametersDetector0.txt'
...
files = [
    "./run_152Eu_GrupoC2/Results/Ch0energy1_fitted_parameters.txt",
    "./run_152Eu_GrupoC2/Results/Ch0energy2_fitted_parameters.txt",
    "./run_152Eu_GrupoC2/Results/Ch0energy3_fitted_parameters.txt",
    "./run_152Eu_GrupoC2/Results/Ch0energy4_fitted_parameters.txt",
    #"./run_152Eu_GrupoC2/Results/Ch0energy5_fitted_parameters.txt",
    "./run_152Eu_GrupoC2/Results/Ch0energy6_fitted_parameters.txt",
    "./run_152Eu_GrupoC2/Results/Ch0energy7_fitted_parameters.txt",
]
