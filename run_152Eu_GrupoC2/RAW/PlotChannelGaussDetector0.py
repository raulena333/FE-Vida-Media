...
energy_europio = {
    'Ch0energy1': {'Energy': 121.78, 'min': 165, 'max': 225},
    'Ch0energy2': {'Energy': 244.69, 'min': 377, 'max': 444},
    'Ch0energy3': {'Energy': 344.29, 'min': 547, 'max': 640},
    'Ch0energy4': {'Energy': 778.9, 'min': 1138, 'max': 1205},
    'Ch0energy5': {'Energy': 964.07, 'min': 1275, 'max': 1337},
}

# Define specific initial guesses for each energy
initial_guesses = {
    'Ch0energy1': [-1., -3., 2.5e3, 196, 3],
    'Ch0energy2': [-1., -3., 400, 413, 3],
    'Ch0energy3': [-1., -3., 700, 588, 3],
    'Ch0energy4': [-1., -3., 220, 1172, 3],
    'Ch0energy5': [-1., -3., 150, 1301, 3],
}

# Load data for the nucleus
file_path = './run_152Eu_GrupoC2/RAW/CH0@DT5751_11655_EspectrumRErrors_run_152Eu_GrupoC2_20241114_131404.txt'
...
plt.plot(channel, counts, label="Espectro detector 0", color="black", linewidth=1)
