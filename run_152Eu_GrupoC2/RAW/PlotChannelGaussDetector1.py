...
energy_europio = {
    'Ch1energy1': {'Energy': 121.78, 'min': 103, 'max': 142},
    'Ch1energy2': {'Energy': 244.69, 'min': 240, 'max': 280},
    'Ch1energy3': {'Energy': 344.29, 'min': 333, 'max': 413},
    'Ch1energy4': {'Energy': 778.9, 'min': 766, 'max': 836},
    'Ch1energy5': {'Energy': 964.07, 'min': 937, 'max': 1006},
}

# Define specific initial guesses for each energy
initial_guesses = {
    'Ch1energy1': [-1., -3., 5e3, 126, 3],
    'Ch1energy2': [-1., -3., 680, 261, 3],
    'Ch1energy3': [-1., -3., 1.3e3, 370, 3],
    'Ch1energy4': [-1., -3., 200, 798, 3],
    'Ch1energy5': [-1., -3., 150, 965, 3],
}

# Load data for the nucleus
file_path = './run_152Eu_GrupoC2/RAW/CH1@DT5751_11655_EspectrumRErrors_run_152Eu_GrupoC2_20241114_131404.txt'
