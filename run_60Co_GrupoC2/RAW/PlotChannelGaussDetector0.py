...
energy_europio = {
    'Ch0energy1': {'Energy': 1173.228, 'min': 1388, 'max': 1453},
    'Ch0energy2': {'Energy': 1332.492, 'min': 1453, 'max': 1533},
}

# Define specific initial guesses for each energy
initial_guesses = {
    'Ch0energy1': [-1., -3., 3e3, 1419, 3],
    'Ch0energy2': [-1., -3., 2.5e3, 1497, 3],
}

# Load data for the nucleus
file_path = './run_60Co_GrupoC2/RAW/CH0@DT5751_11655_EspectrumRErrors_run_60CoGrupoC2_20241114_134013.txt'
